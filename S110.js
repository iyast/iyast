	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				name : 'טיול לסקוטלנד',
				title : {
					media : {word : 'טיול לסקוטלנד'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'התרגשתי לטוס בפעם הראשונה'},
					{word: 'הסתובבנו ברחוב וקטפנו פטל '},
					{word: 'היה מזג אוויר יחסית נעים'},
					{word: 'שמחתי שאפשר לאכול פטל מהשיח'},
					{word: 'היה יפה ואירופאי מסביב'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
