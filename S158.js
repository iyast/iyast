	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				name : 'טיול לאיטליה',
				title : {
					media : {word : 'טיול לאיטליה'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'הסתובבנו במדרחוב מאבן עתיקה'},
					{word: 'קנינו צעיפים כי היה קריר'},
					{word: 'הרחתי פיצה בכל מקום'},
					{word: 'הרגשתי משוחררת וחופשיה'},
					{word: 'היתה לי המון אנרגיה בגוף'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
