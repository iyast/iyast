	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				...
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'ישנו בבית קטן עם חצר פנימית'},
					{word: 'מזג האוויר היה נעים וחמים'},
					{word: 'מחוץ לבית היה אגם גדול מאוד'},
					{word: 'היתה תחושה רגועה ונינוחה'},
					{word: 'לפעמים הכנו ארוחות בדירה'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
