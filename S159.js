	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				name : 'טיול לחווה',
				title : {
					media : {word : 'טיול לחווה'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'נסעתי עם בני משפחה לטיול בקיץ'},
					{word: 'היתה סדנה של אפייה בטאבון'},
					{word: 'היה ריח של פיתות ועיזים'},
					{word: 'מרחנו גבינה וזעתר על הפיתות'},
					{word: 'לא רציתי לחלוב את הפרות'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
