	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				name : 'טיול לפירנאים',
				title : {
					media : {word : 'טיול לפירנאים'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'היה נעים ושמשי יחסית'},
					{word: 'המסלול בהרים היה יפה'},
					{word: 'הצטלמתי עם אבא שלי'},
					{word: 'כל המשפחה נכנסה להתקף צחוק'},
					{word: 'הרגשתי קרובה למשפחה שלי'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
