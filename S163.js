	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				...
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'הלכתי לחנות שדוד שלי ניהל'},
					{word: 'ראיתי איך מסדרים דואר וחבילות'},
					{word: 'התרגשתי לעמוד מאחורי דלפק'},
					{word: 'ראיתי איך מפעילים את הקופה'},
					{word: 'חשבתי שזאת החנות הכי מגניבה'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
