	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				name : 'טיול לטוסקנה',
				title : {
					media : {word : 'טיול לטוסקנה'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'היו נופים מרהיבים'},
					{word: 'האוויר היה צלול'},
					{word: 'המקומיים היו נחמדים ומנומסים'},
					{word: 'אכלתי פסטות ופיצות מגניבות'},
					{word: 'המסע הקולינרי היה מלהיב'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
