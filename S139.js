	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				...
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'אמא ואני עלינו למגדל אייפל'},
					{word: 'הרגשתי על גג העולם'},
					{word: 'אמא קנתה לנו שתי כוסות קאווה'},
					{word: 'זה הרגיש משהו מיוחד שרק אני עושה'},
					{word: 'הייתי מאושרת ומאוד שמחה'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
