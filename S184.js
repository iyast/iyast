	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				...
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'יצאנו מוקדם בבוקר לטיול עם אבא'},
					{word: 'נדהמתי מהפארק שהתחבר ליער'},
					{word: 'הכל היה ירוק ויפה מאוד'},
					{word: 'ראיתי הרים עם פסגות מושלגות'},
					{word: 'זו הייתה חוויה טובה ומפתיעה'}
