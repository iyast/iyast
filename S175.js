	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				name : 'טיול לירדן',
				title : {
					media : {word : 'טיול לירדן'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'ביקרתי בבית של סבא וסבתא'},
					{word: 'זה היה בחורף והיה קר מאוד'},
					{word: 'השלג ירד בכמות גבוהה'},
					{word: 'כמעט עשינו תאונת דרכים'},
					{word: 'זאת הייתה חוויה ממש מפחידה'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
