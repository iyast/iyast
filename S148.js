	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				name : 'טיול לארגנטינה',
				title : {
					media : {word : 'טיול לארגנטינה'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'ביקרנו במפלי האיגוואסו'},
					{word: 'התקרבתי והרגשתי את המים'},
					{word: 'מזג האוויר היה נעים וטרופי'},
					{word: 'ראיתי בעלי חיים מיוחדים'},
					{word: 'שמעתי את קולות החיות והמים'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
