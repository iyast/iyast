	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				name : 'טיול למשחקיה',
				title : {
					media : {word : 'טיול למשחקיה'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'הגענו לחלל המופלא בבאר שבע'},
					{word: 'היו שם הרבה משחקים ומגלשות'},
					{word: 'התביישתי לעלות על האומגה'},
					{word: 'קיבלתי ביטחון בזכות קרוב משפחה'},
					{word: 'הרגשתי גדולה מדיי לשחק'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
