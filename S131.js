	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				name : 'טיול לברלין',
				title : {
					media : {word : 'טיול לברלין'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'נכנסנו לסופר והכל היה זול'},
					{word: 'התלהבתי שהסכימו לי מה שרציתי'},
					{word: 'אישה מהרכבת הבינה אותנו לא נכון'},
					{word: 'שני זרים הציעו לנו לישון אצלם'},
					{word: 'חשדתי שיש להם מניעים רעים'}
