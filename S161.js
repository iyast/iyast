	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				name : 'טיול לבלגיה',
				title : {
					media : {word : 'טיול לבלגיה'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'הסתובבנו ברחובות צדדיים'},
					{word: 'חיפשנו את הפסל של הילד המשתין'},
					{word: 'היו הרבה אנשים אבל לא צפוף'},
					{word: 'הופתעתי מהגודל של הפסל'},
					{word: 'אכלנו גלידה בכיכר המרכזית'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
