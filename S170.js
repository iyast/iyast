	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				name : 'טיול לדיסנילנד',
				title : {
					media : {word : 'טיול לדיסנילנד'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'עליתי על הרבה מתקנים בפארק'},
					{word: 'אכלתי מרק בלחם ושוק הודו'},
					{word: 'אהבתי את האווירה במקום'},
					{word: 'התרגשתי מהמצעד והזיקוקים'},
					{word: 'שמעתי את השירים מהרמקולים'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
