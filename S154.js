	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				name : 'טיול לירושלים',
				title : {
					media : {word : 'טיול לירושלים'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'הסתובבנו בשוק בעיר העתיקה'},
					{word: 'במסגד שמעתי קול רגוע של תפילה'},
					{word: 'התרגשתי להיות שם לראשונה'},
					{word: 'ביקרנו בכנסיה והיה לי מוזר'},
					{word: 'קנינו מאפים וממתקים בשוק'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
