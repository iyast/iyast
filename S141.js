	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				...
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'הייתי עם המשפחה במלון צימרים '},
					{word: 'בכניסה היה עץ עתיק וענק'},
					{word: 'הכנו אוכל במטבחים של הבקתות'},
					{word: 'התכסינו בבוץ וצפנו על המים'},
					{word: 'קיבלתי שרשרת עם אלמוגים'}
