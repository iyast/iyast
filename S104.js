	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				name : 'טיול לבולגריה',
				title : {
					media : {word : 'טיול לבולגריה'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'טסתי עם המשפחה המורחבת'},
					{word: 'חגגנו לאמא שלי יום הולדת'},
					{word: 'ישבנו במסעדה והיו זמרים ברקע'},
					{word: 'סבא שלי שר בבולגרית'},
					{word: 'הרגשתי קרבה למשפחה שלי'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
