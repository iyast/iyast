	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				name : 'טיול לקנדה',
				title : {
					media : {word : 'טיול לקנדה'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'ישנתי אצל משפחה מארחת'},
					{word: 'באחד הימים עשו לנו מסיבה'},
					{word: 'לקחו אותנו למספרה להתארגן'},
					{word: 'נהניתי מהחברים למשלחת והקנדים'},
					{word: 'זה היה ממש מיוחד ומגבש'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
