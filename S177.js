	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				...
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'הסתובבתי במוזיאון הבריטי'},
					{word: 'צילמתי סרטונים מצחיקים עם אחי'},
					{word: 'ראיתי מוצגים עתיקים ומומיות'},
					{word: 'עשינו חיקויים של הפסלים'},
					{word: 'אכלנו כולם בדוכן נקניקיות'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
