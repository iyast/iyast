	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				name : 'טיול לאוסטריה',
				title : {
					media : {word : 'טיול לאוסטריה'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'נכנסנו למערת קרח גדולה'},
					{word: 'היה לי קשה לנשום בהתחלה'},
					{word: 'האורות הצבעוניים היו ממש יפים'},
					{word: 'היה קפוא אבל התלבשנו טוב '},
					{word: 'שרנו שירים והיה כיף'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
