	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				name : 'טיול למנהטן',
				title : {
					media : {word : 'טיול למנהטן'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'ביקרנו במוזאון עם תערוכת פרפרים'},
					{word: 'חיכיתי שפרפרים ינחתו עליי'},
					{word: 'היה חם מאוד בתך החממה'},
					{word: 'התרגשתי להחזיק פרפרים'},
					{word: 'זו היתה חוויה מיוחדת'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
