	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				name : 'טיול לאילת',
				title : {
					media : {word : 'טיול לאילת'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'עשיתי שנורקלינג לראשונה בחיי'},
					{word: 'התרגשתי מכל דג חדש שראיתי'},
					{word: 'הרגשתי בטוח לצלול עם אבי'},
					{word: 'חקרתי את החיים מתחת למים'},
					{word: 'הייתה בי תחושת סקרנות גדולה'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
