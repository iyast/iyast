	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				...
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'אכלנו ארוחת בוקר בחדר אוכל'},
					{word: 'ירדנו לכינרת עם מזרני ים'},
					{word: 'היינו במים כמעט כל היום'},
					{word: 'בערב ישבנו לאכול על הדשא'},
					{word: 'הרגשתי חופש אמיתי, שמחה ואושר'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
