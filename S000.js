	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				name : 'טיול לסיני',
				title : {
					media : {word : 'טיול לסיני'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'התפלשתי בבוץ עם עוד ילדים'},
					{word: 'התגלגלתי בדיונות והחול נדבק אליי'},
					{word: 'צעקנו לאנשים שאנחנו שניצלים'},
					{word: 'היה לי קפוא כשרצתי בין חושות'},
					{word: 'שמחתי שגרמתי לאנשים לחייך'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
