	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				name : 'טיול לרודוס',
				title : {
					media : {word : 'טיול לרודוס'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'מזג האוויר היה חם כמו בארץ'},
					{word: 'היינו בחופים ובבריכה'},
					{word: 'אכלנו והשתזפנו הרבה'},
					{word: 'שכרנו רכב ונסענו לפארקים'},
					{word: 'הרגשתי תחושה משפחתית'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
