	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				name : 'טיול למוסקבה',
				title : {
					media : {word : 'טיול למוסקבה'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'נסעתי עם אבא שלי לתחרות '},
					{word: 'אכלתי דברים די מגעילים'},
					{word: 'הדברים היו שם יקרים'},
					{word: 'מזג האוויר היה קר'},
					{word: 'הרגשתי חופשיה וגאה בעצמי'}
