	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				name : 'טיול לניצנה',
				title : {
					media : {word : 'טיול לניצנה'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'לא נרדמתי מהחום והיתושים'},
					{word: 'נסעתי עם אבא שלי לראות זריחה'},
					{word: 'נרדמתי כשחיכיתי לזריחה'},
					{word: 'לראשונה ראיתי נוף כזה'},
					{word: 'השמיים היו זוהרים וצבעוניים'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
