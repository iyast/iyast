	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				name : 'טיול לטורקיה',
				title : {
					media : {word : 'טיול לטורקיה'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'היינו במלון הכל כלול'},
					{word: 'אני זוכרת בריכה גדולה ומגלשות'},
					{word: 'יכולתי לקחת גלידות חופשי'},
					{word: 'שמעתי מוזיקה טורקית מגיטרה קטנה'},
					{word: 'היה ריח נקי של בית מלון'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
