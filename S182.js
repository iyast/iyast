	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				name : 'טיול לכרתים',
				title : {
					media : {word : 'טיול לכרתים'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'הייתי הרבה בים ובבריכה במלון'},
					{word: 'ראיתי המון תיירים אירופאיים'},
					{word: 'נהניתי ממש בחופשה והיה לי טוב'},
					{word: 'שמרתי על הילדים הקטנים יותר'},
					{word: 'לפעמים הרגשתי קצת מתוסכלת'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
