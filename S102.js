	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				name : 'טיול למדריד',
				title : {
					media : {word : 'טיול למדריד'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'הכניסה לאצטדיון היתה מרגשת'},
					{word: 'היה הרבה רעש באצטדיון'},
					{word: 'דיברו ספרדית ולא הבנתי כלום'},
					{word: 'המשחק היה בערב והיה קר'},
					{word: 'לפעמים היה גשם וזה היה נחמד'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
