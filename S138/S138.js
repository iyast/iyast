	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				name : 'טיול לארה״ב',
				title : {
					media : {word : 'טיול לארה״ב'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'היינו במנהטן בשדרה של חנויות'},
					{word: 'היה מזג אוויר נעים וקייצי'},
					{word: 'ביקרנו בחנות של שוקולדים'},
					{word: 'ראיתי הרבה אנשים, פרסומות וצבעים'},
					{word: 'הרגשתי טוב שהכל מטורף שם'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
