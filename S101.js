	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				name : 'טיול לחרמון',
				title : {
					media : {word : 'טיול לחרמון'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'התלהבתי מהמבנה שגרו בו בצפון'},
					{word: 'אני ואחיות שלי רכבנו על סוסים'},
					{word: 'התרגשתי לראות שלג לראשונה'},
					{word: 'היה ריח של סוסים ועשן'},
					{word: 'בדרך חזרה אכלנו פיתה דרוזית'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
