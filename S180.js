	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				...
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'טיילתי עם המשפחה באזור פריז'},
					{word: 'שטנו במשך שבוע בסירה'},
					{word: 'מזג האוויר היה גשום'},
					{word: 'כשיצאה השמש פתחנו את גג הסירה'},
					{word: 'הרגשתי טוב בסיטואציה וכולם נהנו'}
