	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				name : 'טיול לדרום',
				title : {
					media : {word : 'טיול לדרום'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'נסענו כמה משפחות לנגב'},
					{word: 'רכבנו על גמלים במדבר'},
					{word: 'ישבתי עם שקד על הגמל'},
					{word: 'היה נעים וקריר לקראת הערב'},
					{word: 'נהניתי מאוד מהרכיבה והנוף'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
