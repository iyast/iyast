	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				...
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'מזג האוויר היה נעים ונוח'},
					{word: 'הגו בשבילי מירוץ עם יעדים'},
					{word: 'קנינו מוצרים וחזרנו ליאכטה'},
					{word: 'הכנתי עם אחי ארוחת בוקר'},
					{word: 'הרגשתי שהמשימות תוכננו בשבילי'}
