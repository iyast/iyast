	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				name : 'טיול לספארי',
				title : {
					media : {word : 'טיול לספארי'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'ראיתי מגוון חיות'},
					{word: 'היה קריר ולפעמים ירד גשם'},
					{word: 'ליטפתי גורי אריות'},
					{word: 'הפרווה שלהם היתה רכה ונעימה'},
					{word: 'הרגשתי סקרנות והתרגשות'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
