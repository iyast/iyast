	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				name : 'טיול לצפון',
				title : {
					media : {word : 'טיול לצפון'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'נסעתי לצימר עם המשפחה'},
					{word: 'היינו בפארק מים עד הצהריים'},
					{word: 'אכלתי נקניקיה בלחמניה'},
					{word: 'ראיתי הרבה בריכות ומגלשות'},
					{word: 'שמעתי ילדים צועקים'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
