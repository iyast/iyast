	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				name : 'טיול לים המלח',
				title : {
					media : {word : 'טיול לים המלח'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'הקמנו אוהלים יחסית קרוב לים'},
					{word: 'היה ממש ריח של מלח'},
					{word: 'שיחקנו קלפים ושש-בש'},
					{word: 'בבוקר צבענו את הגוף בבוץ'},
					{word: 'זאת היתה חוויה חדשה וטובה'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
