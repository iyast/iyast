	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				name : 'טיול לסין',
				title : {
					media : {word : 'טיול לסין'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'ביקרנו בבית תה באחד הבקרים'},
					{word: 'טעמתי המון סוגים של תה'},
					{word: 'היה תה מיוחד עם פרח שנפתח'},
					{word: 'היתה מוזיקה נעימה ברקע'},
					{word: 'החוויה הייתה קסומה וכיפית'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
