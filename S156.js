	...
	return iatExtension({
		...
		category1:	{
			...
			attribute2 :
			{
				name : 'טיול לצרפת',
				title : {
					media : {word : 'טיול לצרפת'},
					css : {color:'#0000FF','font-size':'2em'},
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
					{word: 'התרגשתי מהנסיעה ליורודיסני'},
					{word: 'היה לי קר בכפות רגליים'},
					{word: 'הרחתי המבורגר וצ׳יפס בדוכנים'},
					{word: 'עליתי על המתקנים הכי מפחידים'},
					{word: 'נהניתי מאוד והרגשתי שמחה'}
				],
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'2.1em'}
			},	
